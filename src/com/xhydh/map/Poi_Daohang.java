 ...
 * 同时展示如何进行节点浏览并弹出泡泡
 */
public class Poi_Daohang extends Activity implements
	...
	private void initData() {
		...
		new_city = Dingwei.new_city;
		latLng2 = new LatLng(lat, lon);
		Log.e("Daohang", "---------->>>>>>>" + name + new_city);
	}
	...
	public void searchRoute(View v) {
		...
		try {
			...
			Toast.makeText(Poi_Daohang.this, "请检查您的网络！", Toast.LENGTH_SHORT)
			.show();
		}
	}
	...
	public void nodeClick(View v) {
		...
		// show popup
		popupText = new TextView(Poi_Daohang.this);
	...
	public void routeinfo(View view) {
		...
		Intent intent = new Intent(Poi_Daohang.this, Poi_RouteInfo.class);
	...
	public void onGetWalkingRouteResult(WalkingRouteResult result) {
		if (result == null || result.error != SearchResult.ERRORNO.NO_ERROR) {
			Toast.makeText(Poi_Daohang.this, "抱歉，未找到结果", Toast.LENGTH_SHORT)
					.show();
		}
